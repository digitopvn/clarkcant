...
|---|-------|--------|---------|------|--------|
| 1 | [Composition và snapshot contracts](./phase-01-start.md) | 3h | — | **S0** (serial, chạy trước) | Pending |
| 2 | [Jev selector server-side](./phase-02-jev-selector.md) | 2h | 1, exact-model gate | **L1** ∥ | Pending |
