...
| 6 | [Release validation và evidence](./phase-06-release-validation.md) | 4h + chờ user | 5 (và 9 nếu muốn gộp evidence) | **S1** (serial, cuối) | Done (live evidence BLOCKED: thiếu `TYPESAFE_API_KEY`) |
