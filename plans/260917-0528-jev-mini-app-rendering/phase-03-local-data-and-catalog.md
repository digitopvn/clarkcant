...
## Todo
- [ ] Implement scoped data services và local import/create affordances.
- [ ] Register composition và leaf catalog definitions.
- [ ] Build đủ UI regions/states bằng theme hiện có.
- [ ] Pass data/security tests và renderer checks.
